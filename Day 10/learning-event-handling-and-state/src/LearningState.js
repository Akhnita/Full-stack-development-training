...
return (
    <div>
        ...
        we can not call set function of state directly because it will lead many rendering
        */}
        {/*
        <button onClick={() => setIsStudent(true)>click</button> THIS IS ALLOWED
        set function of state can be cancelled inside event handler
        */}
